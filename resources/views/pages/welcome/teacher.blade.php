<section class="container">
    <div class="row align-items-center">
        <div class="col-lg-3 col-md-4 col-sm-10 col-12 mx-auto p-5 text-center">
            <img src="{{cloud(anandamayi()->image_path)}}" class="w-100 rounded-circle border" style="border-color: rgba(0,0,0,0.075) !important">
        </div>
        <div class="col-lg-9 col-md-8 col-12">
            ...
            <p>{{preview(anandamayi()->biography, 36)}}...</p>
