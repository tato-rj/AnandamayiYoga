<div class="row my-4 mx-4 mb-5">
	<div class="col-12">
		<a href="{{$article->path}}" class="link-none"><h4><strong>{{$article->title}}</strong></h4></a>
		<div class="d-flex align-items-center justify-content-between">
			<p class="text-muted"><small>by {{$article->author}} - {{$article->created_at->toFormattedDateString()}}</small></p>
