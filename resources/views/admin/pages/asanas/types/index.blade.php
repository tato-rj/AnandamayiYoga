...
<div class="row">
	<div class="col-12">
		<button type="button" class="btn btn-red" data-toggle="modal" data-target="#add-modal"><i class="fas fa-plus mr-2"></i>Create a new type</button>
	</div>
</div>
...
<div class="row mt-4">
  <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12" id="asanaTypes-list">
    @foreach($asanaTypes as $type)
      @include('admin/pages/asanas/types/show')
    @endforeach
  </div>
</div>
