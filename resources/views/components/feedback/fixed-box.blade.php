<div id="fixed-feedback-container" class="d-none d-sm-block">
	<div class="label" style="margin-top: -42px">
		<p class="m-0 bg-red px-3 cursor-pointer shadow py-2 rounded-top text-white"><strong>@lang('Feedback')</strong></p>
	</div>
	<div class="feedback shadow bg-white px-5 pb-2 pt-4 rounded-left d-none animated-fast">
		...
		<div class="thank-you" style="display: none;">
			<p><strong class="text-success">@lang('All set!')</strong> @lang('Thank you for sharing your feedback.')</p>
		</div>
		<div class="email" style="display: none;">
			<p>@lang('Would you like to receive a follow up?')</p>
		...
		<div>
			...
			<div class="form text-right mb-2" style="display: none;">
				...
				<button class="btn btn-xs btn-warning">@lang('Send')</button>
			</div>
		</div>
	</div>
</div>