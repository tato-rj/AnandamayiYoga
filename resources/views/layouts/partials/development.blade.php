    ...
    <div class="row align-items-center h-100vh">
        <div class="col-lg-4 col-md-6 col-sm-8 col-10 mx-auto text-center">
            <div>
                ...
                <p class="lead mt-2">@lang('We are under development, please come back soon or use your password to continue')</p>            
            </div>
            ...
            <form method="POST" action="/enter">
                ...
                @if(session()->has('denied'))
                  <div class="invalid-feedback">
                    @lang('Ops, wrong password!')
                  </div>
                @endif                    
                </div>
                <button type="submit" class="btn-bold btn-block btn-red">@lang('Continue')</button>
            </form>
        </div>
    </div>
</div>